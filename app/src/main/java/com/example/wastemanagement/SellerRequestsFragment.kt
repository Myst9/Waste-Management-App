...
import com.example.wastemanagement.RequestAdapter
import com.example.wastemanagement.Request
import com.example.wastemanagement.WasteTypeActivity
...
class SellerRequestsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_seller_requests, container, false)
    }
    ...
    private fun loadRequests(activeAdapter: RequestAdapter, archivedAdapter: RequestAdapter) {
